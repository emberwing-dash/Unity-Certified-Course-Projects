...
public partial class @TouchControl: IInputActionCollection2, IDisposable
{
    ...
    ~@TouchControl()
    {
        UnityEngine.Debug.Assert(!m_TouchControls.enabled, "This will cause a leak and performance issues, TouchControl.TouchControls.Disable() has not been called.");
    }
    ...
    public struct TouchControlsActions
    {
        ...
        /// </summary>
        public TouchControlsActions(@TouchControl wrapper) { m_Wrapper = wrapper; }
        /// <summary>
